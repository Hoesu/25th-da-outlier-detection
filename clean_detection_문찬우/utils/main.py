...
def run_model_and_merge(model_choice):
    """
    선택된 모델을 실행하고 JSON 병합, CSV 병합, PNG 병합을 처리하는 함수.
    """
