...
class LOFProcessor:
    def __init__(self, base_dir, isolation_dir, config_path):
        ...
        self.n_neighbors_list = config.get('n_neighbors_list', [20])
        self.min_clean_length = config.get('min_clean_length', 30)
...
if __name__ == "__main__":
    ...
    processor = LOFProcessor(base_dir=base_dir, isolation_dir=isolation_dir, config_path=config_path)
